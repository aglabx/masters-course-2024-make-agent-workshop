...
| Agents: lecture 4 - Взаимодействие        | 01/11/2024 | 17:00              | 18:30            | Взаимодействие с окружением. Разработка API для доступа к данным и сервисам. Задание: Интегрировать не менее трех внешних API.                                           | Zoom     |
| Agents: demo 2 - Прогресс API             | 08/11/2024 | 17:00              | 18:30            | Демонстрация интеграции API и взаимодействия с окружением.                                                                                                              | Zoom     |
| Agents: lecture 5 - Специализация агента  | 15/11/2024 | 17:00              | 18:30            | Разработка уникальных возможностей агента согласно выбранной специализации. Задание: Реализовать ключевую функциональность агента.                                       | Zoom     |
| Agents: lecture 6 - Оптимизация           | 22/11/2024 | 17:00              | 18:30            | Оптимизация и масштабирование. Увеличение производительности агента и параллельная обработка задач.                                                                     | Zoom     |
| Agents: demo 3 - Прогресс специализации   | 25/11/2024 | 18:40              | 20:10            | Демонстрация уникальных возможностей и оптимизации агентов.                                                                                                             | Zoom     |
| Agents: lecture 7 - Тестирование          | 29/11/2024 | 17:00              | 18:30            | Тестирование и отладка. Разработка сценариев и стресс-тестирование. Задание: Создать тестовый набор и провести комплексное тестирование.                                | Zoom     |
| Agents: lecture 8 - Финальная доработка   | 06/12/2024 | 17:00              | 18:30            | Завершение работы над проектами и подготовка демонстраций. Задание: Подготовить презентацию проекта.                                                                     | Zoom     |
| Agents: lecture 9 - Презентация проектов  | 13/12/2024 | 17:00              | 18:30            | Презентация проектов и обсуждение результатов.                                                                                                                          | Zoom     |
| Agents: lecture 10 - Презентация проектов | 20/12/2024 | 17:00              | 18:30            | Вторая часть презентации проектов и обмен опытом.                                                                                                                       | Zoom     |
| Agents: final exam 1 - Защита проекта     | 27/12/2024 | 17:00              | 18:30            | Финальный экзамен: защита проектов.                                                                                                                                     | Zoom     |
| Agents: final exam 2 - Защита проекта     | 30/12/2024 | 18:40              | 20:10            | Финальный экзамен: защита проектов (продолжение).                                                                                                                       | Zoom     |
| Agents: additional session 1 - Подведение итогов | 10/01/2025 | 18:40              | 20:10            | Подведение итогов курса и обсуждение дальнейшего развития навыков.                                                                                                      | Zoom     |
| Agents: additional session 2 - Завершение курса | 17/01/2025 | 18:40              | 20:10            | Завершение курса, выводы и закрытие.                                                                                                                                    | Zoom     |
